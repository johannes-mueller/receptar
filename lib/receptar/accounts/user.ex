defmodule Receptar.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Receptar.Repo)
  ...
  """
  def valid_password?(%Receptar.Accounts.User{hashed_password: hashed_password}, password)
